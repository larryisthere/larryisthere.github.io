...
Dawnary ("we," "our," or "this app") is a mobile application focused on personal diary recording. We take your privacy seriously, and this privacy policy details how we collect, use, store, and protect your information.
...
**Local Storage:**
- All diary content is stored locally on your device by default
- We do not upload your data to any third-party servers
- We do not access, read, or transmit your diary content
...
We use locally stored data only for:
...
This app may require the following permissions, all of which are optional:

**Photo Library Permission:**
- Purpose: Allow you to select images from your photo library to insert into diary entries, or save shared images to your photo library
- Usage: Only used when you actively choose images or save images
- Data Collection: We do not collect or upload your photo library content

**Camera Permission:**
- Purpose: Allow you to take photos and insert them into diary entries
...
- We do not collect or transmit any sensitive information to third-party servers
- The app's core functionality is completely offline and does not require network connectivity
- Data is not shared with any third parties (except through optional iCloud synchronization between your devices)
- iCloud data is protected by Apple's encryption and security measures

### Data Control
- You can delete the app at any time to remove all data
- You can delete specific diary entries through the app's delete functionality
...
- Does not contain advertising services
- Does not use any external data collection tools
- Does not connect to any cloud services or third-party servers other than Apple iCloud and Apple WeatherKit

## Children's Privacy

This app is suitable for users of all ages. Since we do not collect any personal identification information, there are no children's privacy concerns.

## Data Retention

- Your diary data will be retained on your device until you actively delete it
- If iCloud backup is enabled, data will also be retained in your iCloud account until you actively delete it
- Deleting the app will remove all related data on your device, but will not automatically delete data in iCloud (you need to manually delete it in iCloud settings)
...
- Update the "Last Updated" date in this policy
- Notify you of policy changes within the app
- Continue to protect your privacy rights

## Contact Us

If you have any questions or suggestions about this privacy policy, please contact us at:

**Developer:** larryisthere  
**Email:** larryisthere@gmail.com  
